...
SECRET_KEY = 'django-insecure-%ys8u-#n4&y3y+3-g_ljq-_l#fg$szcu38ia@uo6vv=$l^o=$3'
...
# Locations of static files for development
STATICFILES_DIRS = [
    BASE_DIR / 'scraper/static',  # Include app-level static files
]
